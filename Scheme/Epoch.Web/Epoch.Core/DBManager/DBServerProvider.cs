...
namespace Epoch.Core.DBManager
{
    public partial class DBServerProvider
    {
        ...
        public static EpochContext DbContext
        {
            get { return GetEFDbContext(); }
        }
        public static EpochContext GetEFDbContext()
        {
            return GetEFDbContext(null);
        }
        public static EpochContext GetEFDbContext(string dbName)
        {
            EpochContext context = Utilities.HttpContext.Current.RequestServices.GetService(typeof(EpochContext)) as EpochContext;
            if (dbName != null)
            {
        ...
        public static void SetDbContextConnection(EpochContext beefContext, string dbName)
        {
            if (!ConnectionPool.ContainsKey(dbName))
            {
                throw new Exception("数据库连接名称错误");
        ...
        /// <returns></returns>
        public static void GetDbContextConnection<TEntity>(EpochContext defaultDbContext)
        {
