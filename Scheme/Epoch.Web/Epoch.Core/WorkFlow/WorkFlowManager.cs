...
using Epoch.Core.Infrastructure;
...
namespace Epoch.Core.WorkFlow
{
    public static class WorkFlowManager
    {
        ...
        private static void SendMail(Sys_WorkFlowTable workFlow, FilterOptions filterOptions, Sys_WorkFlowTableStep nextStep, EpochContext dbContext)
        {
