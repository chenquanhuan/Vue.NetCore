...
namespace Epoch.Core.EFDbContext
{
    public class EpochContext : DbContext, IDependency
    {
        /// <summary>
        /// 数据库连接名称 
        /// </summary>
        ...
        public EpochContext(string connction)
            : base()
        {
            DataBaseName = connction;
        }

        public EpochContext(DbContextOptions<EpochContext> options)
            : base(options)
        {
